---
name: clean-code
description: "Use when writing, reviewing, or refactoring code to improve readability, naming, structure, and maintainability. Applies Clean Code principles (Robert C. Martin). Triggers on: 'clean up this code', 'improve readability', 'refactor', 'code review', 'naming', 'extract function', 'reduce complexity'."
risk: safe
