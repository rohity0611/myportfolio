...
description: "Use when building web components, pages, dashboards, landing pages, or any UI layout. Generates production-grade frontend interfaces with high design quality. Triggers on: 'build a page', 'create a component', 'design a UI', 'style this', 'make it look better', HTML/CSS/React/Vue/Svelte layouts."
risk: unknown
source: community
